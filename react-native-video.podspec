...
Pod::Spec.new do |s|
  ...
  s.homepage       = 'https://github.com/nolemonnomelon/nn-react-native-video'
  s.source         = { :git => "https://github.com/nolemonnomelon/nn-react-native-video.git", :tag => "v#{s.version}" }
